# Graph Report - wp-plastic-surgery  (2026-08-06)

## Corpus Check
- 64 files · ~29,948 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 342 nodes · 397 edges · 46 communities (39 shown, 7 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd171da7`
...
1. `SettingsController` - 47 edges
2. `SurgeonController` - 37 edges
3. `BaseController` - 21 edges
4. `FaqController` - 19 edges
5. `attributes` - 15 edges
6. `ProcedureController` - 15 edges
...
Cohesion: 0.06
Nodes (7): ThemeSupportController, BaseController, EnqueueController, ModuleRegistrar, FaqBlock, ProcedureHeroBlock, SurgeonListBlock
...
- **Why does `SurgeonController` connect `Surgeon Credentials Controller` to `Surgeon Module Registration`?**
...
- **Should `Graphify Advanced References` be split into smaller, more focused modules?**
